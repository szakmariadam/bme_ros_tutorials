...
int main(int argc, char **argv) {
  ...
  test_message.first_name = "Adam"; // Initializing first name string
  test_message.last_name = "Szakmari";  // Initializing last name string
  test_message.age = 22;             // Initializing age
